...
function reasonColor(reason: string): string {
  if (/overdue|was due/.test(reason)) return "var(--hot)";
  if (/today|tomorrow/.test(reason)) return "var(--warm)";
  return "var(--text-dim)";
}
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div className="row" style={{ gap: 7, marginTop: 3, flexWrap: "wrap" }}>
                  <span style={{ fontSize: 11, color: reasonColor(it.reason) }}>{it.reason}</span>
